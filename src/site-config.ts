...
export const site = {
  ...
  url: "https://anty.jp",
  description:
    "株式会社Antyは、アンティーク調ハンドメイドアクセサリーの製作・販売と、ITシステム・ソフトウェアプロダクトの技術支援を行っています。パールやクリスタルを使用した、右左で違うアシンメトリーな耳飾りをつくっています。",
  ...
  // アクセス解析。GA4の測定IDは本番ビルドのときだけ埋め込みます（pnpm dev では計測しない）。
